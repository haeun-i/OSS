...
def decision_tree_train_test(x_train, x_test, y_train, y_test):
    ...
    acc = accuracy_score(y_test, df_cls.predict(x_test))
    prec = precision_score(y_test, df_cls.predict(x_test))
    recall = recall_score(y_test, df_cls.predict(x_test))
